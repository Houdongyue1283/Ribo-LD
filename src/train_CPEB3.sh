arch=ribo-ld
rbz_type=CPEB3
python Ribo-LD-supervised.py --mode ae --arch $arch --data_path dataset/CPEB3.tsv --max_epochs 100 --latent_dim 64 --seq_len 200
python Ribo-LD-supervised.py --mode diffusion_activity   \
  --arch ${arch}     \
  --data_path dataset/CPEB3.tsv \
